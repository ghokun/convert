...
final class ConversionUtilTest {
    ...
    @ParameterizedTest
    void fromFileExtension1(String fileExtension, Class<? extends Throwable> throwable, String message) {
    ...
    void invalidCsvSeparator1(char csvSeparator) {
        assertThatThrownBy(() -> ConversionOptions.builder()
    ...
    private static Stream<Arguments> invalidFileExtensionProvider() {
        ...
        return Stream.of(
                ...
                arguments("PROPERTİES", IllegalArgumentException.class, "Unsupported file type! [PROPERTİES]"),
