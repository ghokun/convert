...
final class ConvertTest {
  ...
  void help1() {
    ...
    assertThat(systemManager.getError()).isEqualToNormalizingNewlines("""
...
""");
  ...
  final class ConversionTests {
    ...
    private static Stream<Arguments> fromJsonProvider() {
      var outputs = ImmutableSet.of(
          "properties/fromjson.properties", "toml/fromjson.toml", "yaml/fromjson.yaml");
    ...
    private static Stream<Arguments> fromPropertiesProvider() {
      var outputs = ImmutableSet.of(
          "json/fromproperties.json", "toml/fromproperties.toml", "yaml/fromproperties.yaml");
    ...
    private static Stream<Arguments> fromTomlProvider() {
      var outputs = ImmutableSet.of(
          "json/fromtoml.json", "properties/fromtoml.properties", "yaml/fromtoml.yaml");
    ...
    private static Stream<Arguments> fromYamlProvider() {
      var outputs = ImmutableSet.of(
          "json/fromyaml.json", "properties/fromyaml.properties", "toml/fromyaml.toml");
